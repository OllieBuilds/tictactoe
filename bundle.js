...
/***/ function(module, exports, __webpack_require__) {
	...
	var newGameArray = [null, null, null, null, null, null, null, null, null];

	var numTurn = 0;

	var announceWinner = function announceWinner(a) {
	  console.log('Player ' + a + ' wins!');
	  $('#winnerPop').text('Player ' + a + ' wins!').removeClass('hidden');
	};

	var winCases = function winCases(array) {
	...
	$('td').on('click', function () {
	  if (numTurn % 2 === 0 && $(this).text() === '') {
	    ...
	    numTurn += 1;
	    api.updateGame(console.log('updated'), console.log('failed'), gameArray[$(this).attr('id')], 'X');
	    winCases(gameArray);
	    ...
	    // console.log ($(this).get());
	      ...
	      numTurn += 1;
	      // winner = playerTwo;
	      api.updateGame(ui.success, ui.failure, gameArray[$(this).attr('id')], 'O');
	      winCases(gameArray);
	      console.log(gameArray);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#new-game').on('submit', function (event) {
	    ...
	    for (var i = 0; i <= gameplay.gameArray.length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInTwo = function signInTwo(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + 'sign-in',
	    data: data
	...
	var newGame = function newGame(success, failure) {
	  console.log(app);
	  $.ajax({
	    method: 'POST',
	    url: app.api + 'games',
	...
	var joinGame = function joinGame(success, failure, data) {
	...
	var updateGame = function updateGame(success, failure, ugIndex, ugValue) {
	...
	var getId = function getId(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'games/' + gameplay.gameId,
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pwSuccess = function pwSuccess() {
	...
	var signInSuccessTwo = function signInSuccessTwo(data) {
	  app.user2 = data.user;
	...
	module.exports = {
	  ...
	  signInSuccessTwo: signInSuccessTwo,
